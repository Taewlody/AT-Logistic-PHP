...
<div class="row wrapper border-bottom white-bg page-heading">
  <div class="col-lg-10">
    <h2>Transport Type / ประเภทการขนส่ง</h2>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"> <a>Home</a></li>
      <li class="breadcrumb-item"> <a>Common Data</a></li>
      <li class="breadcrumb-item"> <a>Transport Type</a> </li>
    </ol>
  </div>
    ...
    <div class="col-lg-12">
      <div class="ibox ">
        <div class="ibox-title">
          ...
          <div class="ibox-tools"> <a href="transport_type_form?action=add" class="btn btn-primary btn-xs"><i class="fa fa-plus "> </i> Create new </a> </div>
        </div>
...
a.acttiveName,
u.username
FROM $db->dbname.common_transporttype AS c
INNER JOIN $db->dbname.ref_active AS a ON c.comCode = a.comCode AND c.isActive = a.`code`
INNER JOIN $db->dbname.user AS u ON c.comCode = u.comCode AND c.createID = u.usercode order by c.transportCode  ";
$result=$db->query($sql);
$i=1;
$isActiveStype="";
...
?>
                <tr class="gradeX">
                  <td><?php echo $i++; ?></td>
                  <td><?php echo $r['transportCode'];?></td>
                  ...
                  <td class="center">
                    <div class="btn-group">
                      <button class="btn-white btn btn-xs" onClick="location.href='transport_type_form?action=view&transportCode=<?php echo $r['transportCode'];?>' ">View</button>
                      <button class="btn-white btn btn-xs" onClick="location.href='transport_type_form?action=edit&transportCode=<?php echo $r['transportCode'];?>' ">Edit</button>
                      <button class="btn-white btn btn-xs" onClick="return confirmDel('<?php echo $r['transportCode']; ?>','transport_type_action.php');">Delete</button>
                    </div>
                </tr>
<?php  
}
