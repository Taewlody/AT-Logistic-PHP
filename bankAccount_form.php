...
c.editID,
c.editTime
FROM $db->dbname.common_account AS c
WHERE c.comCode='$db->comCode' AND c.accountCode='$accountCode' ";
if($r=$db->fetch($sql)){
	$accountName=$r['accountName'];
	$accountNicname=$r['accountNicname'];
            ...
            success: function (data) {
              ...
              var dataresult=obj.result;
                  if(dataresult=='success'){
                    $("#accountCode").val(obj.documentID);
                    $("#action").val('edit');
                    msgSuccess();
...
<div class="row wrapper border-bottom white-bg page-heading">
  <div class="col-lg-10">
    <h2>Country / Bank Account</h2>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"> <a>Home</a></li>
      <li class="breadcrumb-item"> <a>Common Data</a></li>
      <li class="breadcrumb-item"> <a>Bank Account</a> </li>
      <li class="breadcrumb-item"> <a>Bank Account Form</a></li>
    </ol>
  </div>
      ...
      <div class="ibox ">
        ...
        <form  name="form" id="form" action="" enctype="multipart/form-data" method="post">
            ...
            <div class="form-group  row">
              ...
              <div class="col-md-2">
                <input type="text" name="accountName" id="accountName" class="form-control " value="<?php echo $accountName; ?>"  >
                  <input type="hidden" name="accountCode" id="accountCode" value="<?php echo $accountCode;?>">
              </div>
            </div>
            <div class="form-group  row">
              <label class="col-sm-2 col-form-label">initials Name</label>
              <div class="col-sm-8"><input name="accountNicname" type="text" class="form-control " id="accountNicname" value="<?php echo $accountNicname; ?>" ></div>
            </div>

            <div class="form-group row">
              <label class="col-sm-2 col-form-label"> Account ID</label>
              <div class="col-md-8">
                <input type="text" class="form-control " name="accountID" autocomplete="off" id="accountID"  value="<?php echo $accountID; ?>" >
              </div>
            </div>
            ...
            <div class="form-group row">
              <div class="col-sm-4 col-sm-offset-2">
                <button name="back" class="btn btn-white" type="button" onclick="window.location='bankAccount' "><i class="fa fa-reply"></i> Back</button>
