<div>
    <livewire:component.page-heading title_main="Advance payment" title_sub="เงินสำรองจ่ายล่วงหน้า" breadcrumb_title="Customer"
        breadcrumb_page="Advance parment" />
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-6 text-end">
                                    <a href="{{ route('advance-payment.form', ['action' => 'create']) }}" class="btn btn-primary"><i class="fa fa-plus "> </i> Create new </a>
                                </div>
                            </div>
                            <br/><br/>
                            <div class="row">
