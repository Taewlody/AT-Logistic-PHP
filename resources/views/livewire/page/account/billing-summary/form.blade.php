<div>
  ...
  <livewire:component.page-heading title_main="Billing Summary" title_sub="" 
    breadcrumb_title="Account" breadcrumb_page="Billing Summary" />
            ...
            <div class="card-body">
              ...
              <div class="form-group row">
                <div class="col-sm-10 col-sm-offset-2">
                  ...
                  {{-- <button type="button" class="btn btn-secondary" target="_blank" wire:click="printBillingPDF"><i
                      class="fa fa-print"></i>
                    Print</button> --}}
                  @if(count($selectedInvoice) > 0)  
                  <a class="btn btn-secondary" target="_blank" href="{{ url('/api/print/billing-summary?' . http_build_query(['selectedInvoice' => $selectedInvoice])) }}"><i
