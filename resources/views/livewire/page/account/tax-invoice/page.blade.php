<div>
    <livewire:component.page-heading title_main="Tax Invoice" title_sub="ใบกำกับภาษี" title_sub="ใบกำกับภาษี"
        breadcrumb_title="Account" breadcrumb_page="Tax Invoice" />
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-6 text-end">
                                    <a href="{{ route('tax-invoice.form', ['action' => 'create']) }}" class="btn btn-primary"><i class="fa fa-plus "> </i> Create new </a>
                                </div>
                            </div>
                            <br/><br/>
                            <div class="row">
