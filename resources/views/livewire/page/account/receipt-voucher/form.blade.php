                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <livewire:element.select2 wire:model='data.refJobNo' name="refJobNo" :options="Service::JobOrderSelecter(false)" itemKey="documentID" itemValue="documentID" :searchable="true" >
                                        </div>
                                                ...
                                                <tbody>
                                                    @foreach ($payments as $item)
                                                        <tr class='gradeX'
                                                            ...
                                                            <td class='center'>
                                                                <input type='number' class='form-control' step="0.01" required wire:model.live.debounce.500ms.number="payments.{{ $loop->index }}.amount">
                                                            </td>
                                                            <td class='center'>
                                                                <button type='button'
