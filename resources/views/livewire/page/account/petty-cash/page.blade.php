                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-6 text-end">
                                    <a href="{{ route('account-petty-cash.form', ['action' => 'create']) }}" class="btn btn-primary"><i class="fa fa-plus "> </i> Create new </a>
                                </div>
                            </div>
                            <br/><br/>
                            <div class="row">
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            <a class="btn btn-xs btn-success"
                                                                href="{{ route('account-petty-cash.form', ['action' => 'view', 'id' => $item->documentID]) }}">View</a>
                                                            <a class="btn btn-xs btn-primary"
                                                                href="{{ route('account-petty-cash.form', ['action' => 'edit', 'id' => $item->documentID]) }}">Edit</a>
