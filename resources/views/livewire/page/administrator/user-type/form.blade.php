<div>
    ...
    <livewire:component.page-heading title_main="User Type" title_sub="ประเภทผู้ใช้งาน" breadcrumb_title="Administrator"
        breadcrumb_page="User Type" breadcrumb_page_title="User Type Form" />
                            ...
                            <div class="ibox ">
                                <div class="ibox-content">
                                    ...
                                    <div class="form-group  row">
                                        ...
                                        <div class="col-md-2">
                                            <input name="userTypecode" type="text" class="form-control " id="userTypecode"
                                                readonly autocomplete="off" wire:model="data.userTypecode" >
                                        </div>
                                    </div>

                                    <div class="form-group  row">
                                        <label class="col-sm-2 col-form-label"> Type Name</label>
                                        <div class="col-sm-8"><input name="userTypeName" type="text" class="form-control " wire:model="data.userTypeName"
                                                id="userTypeName" autocomplete="empty" @disabled($action != 'create' && $action != 'edit')></div>
                                    </div>
