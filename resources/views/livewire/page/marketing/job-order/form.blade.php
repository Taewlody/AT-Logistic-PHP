                        ...
                        <div class="ibox-content">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-10 col-sm-offset-2">
                                    <button name="back" class="btn btn-white" type="button" wire:click="$this->redirectRoute('job-order')" >
                                        <i class="fa fa-reply"></i> Back</button>

                                    <button name="Approve" id="Approve" class="btn btn-primary" wire:click="save"
