                                            ...
                                            <table class="table" width="100%" id="table_charge">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="width:5%; max-width: 120px;">Tax รวม</th>
                                                        <th style="width:5%; min-width: 80px;">Vat</th>
                                                        <th style="width:5%; max-width: 120px;">Vat รวม</th>
                                                ...
                                                <tbody>
                                                    @foreach ($payments as $item)
                                                        <tr class='gradeX'
                                                            ...
                                                            <td class='center'>
                                                                <select class="form-control valid" wire:model.change='payments.{{ $loop->index }}.tax' wire:change='changeTax($event.target.value, {{$loop->index}})'>
                                                              ...
                                                              <td class='center'>
                                                                <input type="text" class='form-control' wire:model="payments.{{ $loop->index }}.taxamount" readonly>
                                                              </td>
                                                              <td class='center'>
                                                                <select class="form-control valid" wire:model.change='payments.{{ $loop->index }}.vat' wire:change='changeVat($event.target.value, {{$loop->index}})'>
                                                                  <option value="0">0%</option>
                                                                  <option value="7">7%</option>
                                                                </select>
                                                              </td>
                                                              <td class='center'>
                                                                <input type="text" class='form-control' wire:model="payments.{{ $loop->index }}.vatamount" readonly>
                                                              </td>
                                                              <td class='center'>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="min-width: 150px;">
                                                              <input name="sumTotal" id="sumTotal" class='form-control'  value="{{ Service::MoneyFormat($this->cal_price->total) }}" readonly></td>
                                                          </tr>
                                                          <tr>
                                                            <td><strong>Tax 1% :</strong></td>
                                                            <td><input name="tax1" id="tax1" class='form-control'  value="{{ Service::MoneyFormat($this->cal_price->tax1) }}" required readonly></td>
                                                          </tr>
                                                          <tr>
                                                            <td><strong>Tax 3% :</strong></td>
                                                            <td><input name="tax3" id="tax3"  class='form-control' value="{{ Service::MoneyFormat($this->cal_price->tax3) }}" required readonly></td>
                                                          </tr>
                                                          <tr>
                                                            <td><strong>Vat Total : </strong></td>
                                                            <td><input name="tax7" id="tax7" class='form-control' value="{{ Service::MoneyFormat($this->cal_price->vatTotal) }}" required readonly></td>
                                                          </tr>
                                                          ...
                                                          <tr>
                                                             <td><strong>GRAND TOTAL:</strong></td>
                                                              <td style="text-align: left"><span id="showgrandTotal">{{ Service::MoneyFormat($this->cal_price->grandTotal) }}</span>
                                                          </tr>
                                                            
                                                         <tr>
                                                             <td><strong>นำไปคิดภาษีซื้อ :</strong></td>
                                                              <td style="text-align: left"><label class="checkbox-inline i-checks">
                                                      <input type="checkbox" name="purchasevat"  id="purchasevat" wire:model.boolean='data.purchasevat'>
                                                     </label></td>
                                                          </tr>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-10 col-sm-offset-2">
                                    <a name="back" class="btn btn-white" type="button" href="{{ route('shipping-payment-voucher') }}" wire.loading.attr="disabled">
