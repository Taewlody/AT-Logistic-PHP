                        ...
                        <thead>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a class="btn btn-xs btn-success" href="{{ route('port.form', ['action' => 'view', 'id' => $item->portCode])}}">View</a>
                                            <a class="btn btn-xs btn-primary" href="{{ route('port.form', ['action' => 'edit', 'id' => $item->portCode])}}">Edit</a>
