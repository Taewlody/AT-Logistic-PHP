                ...
                <div class="row">
                    <div class="col-7"></div>
                        ...
                        <div class="col-2" style="justify-content: flex-end; display: flex">
                            <a href="{{ route('charges-type.form', ['action' => 'create']) }}" class="btn btn-primary">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a class="btn btn-xs btn-success"
                                                href="{{ route('charges-type.form', ['action' => 'view', 'id' => $item->typeCode]) }}">View</a>
                                            <a class="btn btn-xs btn-primary"
                                                href="{{ route('charges-type.form', ['action' => 'edit', 'id' => $item->typeCode]) }}">Edit</a>
                                            <button class="btn btn-xs btn-danger"
                                            wire:confirm="Are you sure want to delete {{$item->typeName}}" wire:click="delete('{{$item->typeCode}}')" wire:refresh="$refresh">Delete</button>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
