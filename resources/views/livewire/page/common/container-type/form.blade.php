<div>
    ...
    <livewire:component.page-heading title_main="Container Type" title_sub="ประเภทตู้คอนเทนเนอร์"
        breadcrumb_title="Common Data" breadcrumb_page="Container Type" breadcrumb_page_title="Container Type Form" />
            ...
            <div class="card-body">
                <form class="form-body" wire:submit="save" onkeydown="return event.key != 'Enter';">
                    ...
                    <div class="form-group  row">
                        ...
                        <div class="col-md-2">
                            <input name="containertypeCode" type="text" class="form-control "
                                wire:model="data.containertypeCode" id="containertypeCode" autocomplete="off"
                    ...
                    <div class="form-group  row">
                        ...
                        <div class="col-sm-8">
                            <input name="containertypeName" type="text" wire:model="data.containertypeName"
                                class="form-control " id="containertypeName" autocomplete="empty"
