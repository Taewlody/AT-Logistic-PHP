<div>
    <livewire:component.page-heading title_en="Customer" title_th="ลูกค้า" breadcrumb_title="Common Data" breadcrumb_page="Cusotmer" />
                                ...
                                <thead>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <button class="btn-white btn btn-xs" onClick="location.href='port_form?action=view&portCode={{ $item->cusCode }}">View</button>
                                                    <button class="btn-white btn btn-xs" onClick="location.href='port_form?action=edit&portCode={{ $item->cusCode }}">Edit</button>
                                                    <button class="btn-white btn btn-xs" onClick="return confirmDel('{{ $item->cusCode }}','port_action.php');">Delete</button>
                                                </div>
                                            </td>
                                        </tr>
                                        @endforeach
