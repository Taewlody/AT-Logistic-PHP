<div>
    <livewire:component.page-heading title_en="Supplier" title_th="ผู้จำหน่าย" breadcrumb_title="Common Data" breadcrumb_page="Supplier" />
                                ...
                                <thead>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <button class="btn-white btn btn-xs" onClick="location.href='port_form?action=view&portCode={{ $item->supCode }}">View</button>
                                                    <button class="btn-white btn btn-xs" onClick="location.href='port_form?action=edit&portCode={{ $item->supCode }}">Edit</button>
                                                    <button class="btn-white btn btn-xs" onClick="return confirmDel('{{ $item->supCode }}','port_action.php');">Delete</button>
                                                </div>
                                            </td>
                                        </tr>
                                        @endforeach
