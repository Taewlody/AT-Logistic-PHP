                    ...
                    <div class="row">
                        ...
                        <div class="col-3">
                            <input type="text" id="search" name="search" class="form-control"
                                wire:model.live="searchText" placeholder="Search in table">
                        </div>
                        <div class="col-2" style="justify-content: flex-end; display: flex">
                            <a href="{{ route('commodity.form', ['action' => 'create']) }}" class="btn btn-primary">
                        ...
                        <table class="table" data-page-size="{{ $data->total() }}">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width:40%">Commodity Name</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $item->commodityNameTH }}</td>
                                    <td class="center">
                                        <span @class(['badge', 'label-primary'=> $item->isActive, 'label-secondary' =>
                                            !$item->isActive])>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a type="button" class="btn btn-success btn-xs"
                                                href="{{ route('commodity.form', ['id' => $item->commodityCode ]) }}">View</a>
                                            <a type="button" class="btn btn-info btn-xs"
                                                href="{{ route('commodity.form', ['action' => 'edit', 'id' => $item->commodityCode ]) }}">Edit</a>
                                            <a type="button" class="btn btn-danger btn-xs"
                                                wire:confirm="Are you sure want to delete {{$item->commodityNameTH}}"
                                                wire:click="delete('{{$item->commodityCode}}')"
                                                wire:refresh="$refresh">Delete</a>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
