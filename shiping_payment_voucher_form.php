...
INNER JOIN common_charge AS c ON t.comCode = c.comCode AND t.chargeCode = c.chargeCode
                  ...
                  <table class="table invoice-total">
                    <tbody>
                      <tr>
                        ...
                        <td><span id="total"><?php echo $sumTotal; ?></span>
							<input type="hidden" name="sumTotal" id="sumTotal" value="<?php echo $sumTotal; ?>"> 
						</td>
                      </tr>
                      <tr>
                        <td><strong>VAT</strong></td>
                        <td><span id="vat7"><?php echo n2($sumTotal*7/100); ?> </span></td>
                      </tr>
                      <tr>
                        <td><strong>WITHHOLDING TAX</strong></td>
						  <td><span id="vat3"><?php echo n2($sumTotal*3/100) ?></span></td>
                      </tr>
...
WHERE t.comCode='$db->comCode' AND t.documentID='$documentID' ";
                  ...
                  ?>
                    ...
                    <tr class='gradeX' id='tr<?php echo $i; ?>'>
                      ...
                      <td class='center'> <a class='btn-white btn btn-xs' href='supplier_path/<?php echo $r['supCode'] . '/' . $r['fileName']; ?>' target='_blank'>View</a> </button>&nbsp;<button type='button' class='btn-white btn btn-xs' onClick='return FN_Remove_Table("<?php echo $i; ?>")'>Remove</button></td>
                    </tr>
          ...
          <div class="ibox-content">
            ...
            <div class="form-group row">
              <div class="col-sm-10 col-sm-offset-2">
                <button name="back" class="btn btn-white" type="button" onclick="window.location='shiping_payment_voucher'"><i class="fa fa-reply"></i> Back</button>
                <?php
                if ($documentstatus != 'A') {
                ?>
