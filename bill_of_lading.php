...
<div class="wrapper wrapper-content animated fadeInRight ecommerce">
  ...
  <div class="ibox-title">
          ...
          <div class="ibox-tools"> 
			  <a href="bill_of_lading_form?action=add" class="btn btn-primary btn-xs"><i class="fa fa-plus "> </i> Create new </a> 
...
s.empName,
rf.status_name
FROM $db->dbname.bill_of_lading AS j
...
?>
                <tr>
                  ...
                  <td class="center">
                    <div class="btn-group">
                      <button class="btn-white btn btn-xs" onClick="location.href='bill_of_lading_form?action=view&documentID=<?php echo $r['documentID'];?>' ">View</button>
                      <button class="btn-white btn btn-xs" onClick="location.href='bill_of_lading_form?action=edit&documentID=<?php echo $r['documentID'];?>' ">Edit</button>
                      <button class="btn-white btn btn-xs" onClick="return confirmDel('<?php echo $r['documentID']; ?>','bill_of_landing_action.php');">Delete</button>
                    </div>
                  </td>
                </tr>
                <?php  
