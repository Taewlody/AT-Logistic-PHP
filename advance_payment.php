...
<div class="row wrapper border-bottom white-bg page-heading">
  <div class="col-lg-10">
    <h2>Advance Payment / เงินสำรองจ่ายล่วงหน้า</h2>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"> <a>Home</a></li>
      <li class="breadcrumb-item"> <a>Account</a></li>
      <li class="breadcrumb-item"><a>Advance</a> Payment</li>
    </ol>
  </div>
...
<div class="wrapper wrapper-content animated fadeInRight ecommerce">
  ...
  <div class="ibox-title">
          ...
          <div class="ibox-tools"> 
			  <a href="advance_payment_form?action=add" class="btn btn-primary btn-xs"><i class="fa fa-plus "> </i> Create new </a> 
...
j.sumTotal,
rf.status_name
FROM $db->dbname.advance_payment AS j
...
AND j.cusCode LIKE'$cusCode%' and (  j.documentID like '%$documentID%'  and   j.refJobNo LIKE '%$refJobNo%' ) 
...
?>
                <tr>
                  ...
                  <td align="center"><?php echo $r['refJobNo'];?></td>
                  <td><?php echo number($r['sumTotal'],2);?></td>
                  <td class="center"> <span class="label label-<?php echo $isActiveStype;?>"><?php echo $r['status_name']; ?></span></td>
                  <td class="center">
                    <div class="btn-group">
<button class="btn-white btn btn-xs" onClick="location.href='advance_payment_form?action=view&documentID=<?php echo $r['documentID'];?>' ">View</button>
 <?php if($r['documentstatus']!='A' or $_SESSION['userTypecode']=='1'){ ?>                       
<button class="btn-white btn btn-xs" onClick="location.href='advance_payment_form?action=edit&documentID=<?php echo $r['documentID'];?>' ">Edit</button>
    <?php } ?>                    

                        <button class="btn-white btn btn-xs" onClick="return confirmDel('<?php echo $r['documentID']; ?>','advance_payment_action.php');">Delete</button>
                    </div>
                  </td>
                </tr>
                <?php  
