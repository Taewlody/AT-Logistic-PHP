...
p.editID,
p.editTime
FROM $db->dbname.receipt_voucher AS p
    ...
    $("#save").click(function(event) {
      ...
      if ($('#form').valid()) {
        ...
        $.ajax({
          ...
          url: "receipt_voucher_action.php",
          data: data,
          processData: false,
          contentType: false,
          cache: false,
...
console.log("Result : ", data);
    ...
    $("#btnUpload").click(function(event) {
      ...
      $.ajax({
        type: "POST",
        enctype: 'multipart/form-data',
        url: "receipt_voucher_upload.php",
        data: data,
        processData: false,
        contentType: false,
        cache: false,
        ...
        success: function(result) {
          ...
          if (obj.result == 'success') {
            ...
            $("#table_attach").append(" <tr class='gradeX' id='tr" + rowIdx_atach + "'> " +
              ...
              " <td class='center'> <a class='btn-white btn btn-xs' href='supplier_path/" + $("#cusCode").val() + "/" + obj.fileName + "' target='_blank'>View</a> </button>&nbsp;<button type='button' class='btn-white btn btn-xs' onClick='return FN_Remove_Table(" + rowIdx_atach + ")'>Remove</button></td>  " +
              " </tr>");
            rowIdx_atach++;
            // msgSuccess();
            msgUploadSuccess();
...
<div class="row wrapper border-bottom white-bg page-heading">
  <div class="col-lg-6">
    <h2>Receipt Voucher / ใบสำคัญรับ</h2>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"> <a>Home</a></li>
      <li class="breadcrumb-item"> <a>Account</a></li>
      <li class="breadcrumb-item"> <a>Receipt Voucher</a> </li>
      <li class="breadcrumb-item"> <a>Receipt Voucher Form</a></li>
    </ol>
  </div>
</div>
      ...
      <div class="col-lg-7" style="margin-bottom: 1px; ">
        <div class="ibox ">
          ...
          <div class="ibox-content">
            ...
            <div class="form-group row">
              <label class="col-lg-2 col-form-label"><span class="col-form-label" style="padding-top: 5px;">รับชำระจาก</span></label>
              <div class="col-md-4">
...
t.chartDetail,
t.amount
FROM $db->dbname.receipt_voucher_items AS t  WHERE t.comCode='$db->comCode' AND t.documentID='$documentID' ";
                    $result = $db->query($sql);
                    $i = 1;
                    $isActiveStype = "";
                    $rowIdx = 99;
          ...
          <div class="ibox-content">
            ...
            <div class="form-group row">
              <div class="col-sm-10 col-sm-offset-2">
                <button name="back" class="btn btn-white" type="button" onclick="window.location='receipt_voucher'"><i class="fa fa-reply"></i> Back</button>
                <?php
                ...
                <?php }} ?>
                     ...
                     <button class="btn btn-white " type="button" onclick="openInNewTab('<?php echo 'receipt_voucher_pdf';?>');" ><i class="fa fa-print"></i> Print</button> 
