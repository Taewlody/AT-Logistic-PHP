...
$( "#stu_location" ).keyup(function() {
    ...
    $("#addpacked").click(function(event) {
      ...
      $("#table_packed").append(" <tr class='gradeX' id='tr" + rowIdxpacked + "'> " +
        " <td>" + rowIdxpacked + "<input type='hidden' name='chargeitems[]'   value='" + $("#chargeCode").val() + "' id='chargeitems" + rowIdxpacked + "'>                      <input type='hidden' name='ref_paymentCode[]'   value='' id='ref_paymentCode" + rowIdxpacked + "'></td> " +
" <td><input type='text' name='chargesDetail[]' class='form-control' value='" + $("#chargeCode option:selected" ).text() + "' id='chargesDetail" + rowIdxpacked + "'></td> " +
" <td class='center'><input type='number' name='chargesCost[]'  onkeyup='call_price()' class='form-control' value='0' id='chargesCost" + rowIdxpacked + "'></td>  " +
" <td class='center'><input type='number' name='chargesReceive[]'  onkeyup='call_price()' class='form-control' value='0' id='chargesReceive" + rowIdxpacked + "'></td>  " +
" <td class='center'><input type='number' name='chargesbillReceive[]' onkeyup='call_price()' class='form-control' value='0' id='chargesbillReceive" + rowIdxpacked + "'></td>  " +
" <td class='center'><button type='button' class='btn-white btn btn-xs' onClick='return FN_Remove_Table(" + rowIdxpacked + ")'>Remove</button></td>  " +
        " </tr>");
    //  $('#containner' + rowIdxpacked).load('job_form_loadcharge.php');
...
" <td class='center'><input type='number' name='chargesCost[]'  onkeyup='call_price()' class='form-control' value='0' id='chargesCost" + rowIdx + "'></td>  " +
" <td class='center'><input type='number' name='chargesReceive[]'  onkeyup='call_price()' class='form-control' value='0' id='chargesReceive" + rowIdx + "'></td>  " +
" <td class='center'><input type='number' name='chargesbillReceive[]' onkeyup='call_price()' class='form-control' value='0' id='chargesbillReceive" + rowIdx + "'></td>  " +
        ...
        <div class="ibox ">
          ...
          <div class="ibox-content">
            ...
            <div class="form-group row date">
              ...
              <div class="col-lg-4">
                <div class="input-group date"> <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                  <input type="text" name="etdDate" class="form-control" value="<?php echo $etdDate; ?>" >
                </div>
              </div>
              <div class="col-md-2">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-2">
                <label class="col-form-label" style="padding-top: 5px;">Free Time Expire</label>
              </div>
              <div class="col-md-4">
        ...
        <div class="ibox ">
          ...
          <div class="ibox-content">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-5">
                <input type="text" name="vessel" class="form-control" id="vessel" value="<?php echo $vessel;?>">
              </div>
                       <div class="col-md-1">
                <label class="col-form-label" style="padding-top: 5px;">VOY</label>
              </div>
...
?>    
                      ...
                      <td>&nbsp;&nbsp;<?php echo $i; ?></td>
                      <td>
                          <select name="containerType[]" class="select2_single form-control select2" id="containerType<?php echo $i_container; ?>" style="width: 100%">
                            <?php $db->s_containerType($r['containerType']); ?>
                          </select>
                        </td>
...
?> 
 <tr class="gradeX">
                      ...
                      <td class="center"><select name="packaed_unit[]" class="select2_single form-control select2" style="width: 100%" id="packaed_unit<?php echo $i; ?>" onchange="return FN_CalPacked('<?php echo $i; ?>');">
                          <?php $db->s_unit($r['packaed_unit']); ?>
                        </select></td>
                      <td class="center"><input type="number" readonly name="packaed_totalCBM[]" class="form-control" value="<?php echo $r['packaed_totalCBM'];?>" id="packaed_totalCBM<?php echo $i; ?>"></td>
                      <td class="center"><input type="number" readonly name="packaed_totalWeight[]" class="form-control" value="<?php echo n2($r['packaed_totalWeight']);?>" id="packaed_totalWeight<?php echo $i; ?>"></td>
...
WHERE pm.comCode='$db->comCode' AND pm.refJobNo='$documentID'
) as t
...
<td class="center">
    <input type="number" name="chargesCost[]" <?php if($r["ref_paymentCode"]!=''){echo"readonly";};?>  onkeyup="call_price()" class="form-control" value="<?php echo $r["chargesCost"];?>" id="chargesCost<?php echo $rowIdx;?>">
           </td>
<td class="center"><input type="number" name="chargesReceive[]" onkeyup="call_price()"  class="form-control" value="<?php echo $r["chargesReceive"];?>" id="chargesReceive<?php echo $rowIdx;?>"></td>
<td class="center"><input type="number" name="chargesbillReceive[]" onkeyup="call_price()"  class="form-control" value="<?php echo $r["chargesbillReceive"];?>" id="chargesbillReceive<?php echo $rowIdx;?>"></td>  
 ...
 ?>                     
                  ...
                  <tfoot>
                    ...
                    <tr>
                      <td style="
      width:5%"></td>
                    <td style="width:50%; text-align: right;">Toal 7%</td>
                ...
                <table class="table invoice-total">
                  <tbody>
                    <tr>
                      ...
                      <td><span id="total">0</span><input type="hidden" id="h_total" name="h_total" value=""></td>
                    </tr>
                    <tr>
                      <td><strong>ค่าบริการ Tax (3%) :</strong></td>
                      <td><span id="tax3">0</span><input type="hidden" id="h_tax3" name="h_tax3" value=""></td>
                    </tr>
                    <tr>
                      <td><strong>ค่าขนส่ง Tax (1%) :</strong></td>
                      <td><span id="tax1">0</span><input type="hidden" id="h_tax1"  name="h_tax1" value=""></td>
                    </tr>
                    <tr>
                      <td><strong>รวม :</strong></td>
                      <td><span id="grand_total">0</span><input type="hidden" id="h_grand_total" name="h_grand_total" value=""></td>
                    </tr>
                    <tr>
...
?>           
                      ...
                      <td><span id="cus_paid"><?php echo n2($h_cus_paid)?></span><input type="hidden" id="h_cus_paid" name="h_cus_paid" value="<?php echo n2($h_cus_paid)?>"></td>
                    </tr>
                    <tr>
                      <td><strong>คงเหลือจ่ายจริง</strong></td>
                      <td><span id="net_pad">0</span><input type="hidden" id="h_net_pad" name="h_net_pad" value=""></td>
                    </tr>
                  </tbody>
                </table>
              </div>
