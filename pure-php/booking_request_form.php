...
<div class="row wrapper border-bottom white-bg page-heading">
  <div class="col-lg-6">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item">Customer<a></a></li>
      <li class="breadcrumb-item"> <a>Booking request </a> </li>
      <li class="breadcrumb-item"> <a>Booking request Form</a></li>
    </ol>
  </div>
          ...
          <div class="ibox-content">
            ...
            <div class="form-group row date">
              ...
              <div class="col-lg-4">
                ...
                <div class="input-group date">
                  <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" name="etaDate" class="form-control" value="<?php echo $etaDate; ?>">
                </div>
        ...
        <div class="ibox ">
          ...
          <div class="ibox-content">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-10">
                <textarea name="note" rows="2" class="form-control" id="note"></textarea>
              </div>
            </div>
        ...
        <div class="ibox ">
          ...
          <div class="ibox-content collapse">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-2">
                <div class="input-group date">
                  <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" name="stu_date" class="form-control" value="<?php echo $stu_date; ?>">
                </div>
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-2">
                <div class="input-group date">
                  <span class="input-group-addon"><i class="fa fa-calendar "></i></span><input type="text" name="cy_date" id="cy_date" class="form-control" value="<?php echo $cy_date; ?>">
                </div>
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-2">
                <div class="input-group date">
                  <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" name="rtn_date" id="rtn_date" class="form-control" value="<?php echo $rtn_date; ?>">
                </div>
              </div>
            </div>
                  ...
                  <tbody>
                    ...
                    ?>
                      ...
                      <tr>
                        ...
                        <td><input type="number" name="containerNo[]" id="containerNo<?php echo $i; ?>" class="form-control" value=""></td>
                ...
                <table class="table dataTables" width="100%">
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr class="gradeX">
                        <td><?php echo $i; ?></td>
                        <td><span class="center"><input type="number" name="packaed_width[]" class="form-control" value="" id="packaed_width<?php echo $i; ?>" onchange="return FN_CalPacked('<?php echo $i; ?>');"></span></td>
                        <td><span class="center"><input type="number" name="packaed_length[]" class="form-control" value="" id="packaed_length<?php echo $i; ?>" onchange="return FN_CalPacked('<?php echo $i; ?>');"></span></td>
                        ...
                        <td class="center">
                          <select name="packaed_unit[]" class="select2_single form-control select2" style="width: 100%" id="packaed_unit<?php echo $i; ?>" onchange="return FN_CalPacked('<?php echo $i; ?>');">
                            <?php $db->s_unit(); ?>
                          </select>
                        </td>
        ...
        <div class="ibox ">
          ...
          <div class="ibox-content collapse">
            ...
            <div class="form-group row">
              ...
              <div id="container_attach" class="fileinput fileinput-new" data-provides="fileinput">
          ...
          <div class="ibox-content">
            ...
            <div class="form-group row">
              <div class="col-sm-10 col-sm-offset-2">
                ...
                <button name="back" class="btn btn-white" type="button" onclick="window.location='booking_request'"><i class="fa fa-reply"></i> Back</button>
