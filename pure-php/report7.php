...
<div class="row wrapper border-bottom white-bg page-heading">
  <div class="col-lg-10">
    <h2>รายงาน ใบสำคัญรับ</h2>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"> <a>Home</a></li>
      <li class="breadcrumb-item">Report</li>
      <li class="breadcrumb-item">รายงานใบสำคัญรับ</li>
    </ol>
  </div>
            ...
            <div class="row">
              ...
              <thead>
                <tr>
                  ...
                  <th data-toggle="true" width="15%">Customer</th>
...
INNER JOIN $db->dbname.receipt_voucher_items AS ji ON j.comCode = ji.comCode AND j.documentID = ji.documentID
