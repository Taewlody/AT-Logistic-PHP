...
<div class="row wrapper border-bottom white-bg page-heading">
  <div class="col-lg-6">
    <h2>Reserve Payment / ใบสำรองรับ</h2>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"> <a>Home</a></li>
      <li class="breadcrumb-item"> <a>Shipping</a></li>
      <li class="breadcrumb-item"> <a>Reserve Receipt</a> </li>
      <li class="breadcrumb-item"> <a> <a>Reserve Receipt</a> Form</a></li>
    </ol>
  </div>
</div>
    ...
    <div class="ibox ">
      ...
      <div class="ibox-content">
          ...
          <table class="table" width="100%">
            ...
            <tbody>
              <tr class="gradeX">
                ...
                <td>เอกสารประกอบ1</td>
                <td>&nbsp;</td>
                <td class="center"><a href="customer_form"><i class="fa fa-search text-navy"></i></a>&nbsp;&nbsp;&nbsp; <a href="customer_form"><i class="fa fa-trash text-navy"></i></a></td>
              </tr>
              <tr class="gradeX">
                <td>2</td>
                <td>เอกสารประกอบ2</td>
        ...
        <div class="form-group row">
          ...
          <div class="col-md-4">
            <button class="btn btn-primary " type="submit"><i class="fa fa-save"></i> Upload File</button>
          </div>
        </div>
      </div>
    </div>
