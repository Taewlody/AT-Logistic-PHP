...
<div class="row wrapper border-bottom white-bg page-heading">
  <div class="col-lg-10">
    <h2>รายงาน ภาษีขาย</h2>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"> <a>Home</a></li>
      <li class="breadcrumb-item"> <a>รายงาน</a></li>
      <li class="breadcrumb-item"> <a>รายงาน ภาษีขาย</a></li>
    </ol>
  </div>
                    ...
                    <div class="form-group" >
                      ...
                      <div class="input-group">
                        <button type="submit" class="btn btn-primary">Search</button>&nbsp;
						    <button class="btn btn-white " type="button" onclick="openInNewTab('<?php echo 'report8_pdf';?>');"  ><i class="fa fa-print"></i> Print</button>
                      </div>
                    </div>
                  </div>
                </div>
...
?>
                <tr>
                  ...
                  <td><?php echo n2($r['priceBeforevat']);?></td>
