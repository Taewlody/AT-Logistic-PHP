...
INNER JOIN $db->dbname.user AS u ON c.comCode = u.comCode AND c.createID = u.usercode order by c.countryNameTH  ";
$result=$db->query($sql);
$i=1;
$isActiveStype="";
...
?>
                <tr class="gradeX">
                  ...
                  <td class="center">
                    <div class="btn-group">
                      <button class="btn-white btn btn-xs" onClick="location.href='country_form?action=view&countryCode=<?php echo $r['countryCode'];?>' ">View</button>
                      <button class="btn-white btn btn-xs" onClick="location.href='country_form?action=edit&countryCode=<?php echo $r['countryCode'];?>' ">Edit</button>
                      <button class="btn-white btn btn-xs" onClick="return confirmDel('<?php echo $r['countryCode']; ?>','country_action.php');">Delete</button>
                    </div>
                </tr>
<?php  
}
