...
<div class="wrapper wrapper-content animated fadeInRight ecommerce">
  ...
  <div class="ibox-title">
          ...
          <div class="ibox-tools"> 
			  <a href="petty_cash_form?action=add" class="btn btn-primary btn-xs"><i class="fa fa-plus "> </i> Create new </a> 
...
j.grandTotal,
rf.status_name
FROM $db->dbname.petty_cash AS j
...
?>
                <tr>
                  ...
                  <td class="center">
                    <div class="btn-group">
<button class="btn-white btn btn-xs" onClick="location.href='petty_cash_form?action=view&documentID=<?php echo $r['documentID'];?>&sub=<?php echo $sub;?>' ">View</button>
 <?php if ($r['documentstatus']!='A' || $_SESSION['userTypecode']=='1') { ?>                       
<button class="btn-white btn btn-xs" onClick="location.href='petty_cash_form?action=edit&documentID=<?php echo $r['documentID'];?>&sub=<?php echo $sub;?>' ">Edit</button>
<button class="btn-white btn btn-xs" onClick="return confirmDel('<?php echo $r['documentID']; ?>','petty_cash_action.php');">Delete</button>
 <?php } ?>                         </div>
                  </td>
                </tr>
                <?php  
