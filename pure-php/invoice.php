...
<div class="wrapper wrapper-content animated fadeInRight ecommerce">
  ...
  <div class="ibox-title">
          ...
          <div class="ibox-tools"> 
			  <a href="invoice_form?action=add" class="btn btn-primary btn-xs"><i class="fa fa-plus "> </i> Create new </a> 
              ...
              <div class="row m-b-sm m-t-sm">
                <div class="col-md-11">
                  ...
                  <div class="form-group" >
                      ...
                      <div class="input-group">
                        <input type="text" id="jobNo" name="jobNo" class="form-control" value="<?php echo $jobNo;?>">
                      </div>
                    </div>
...
j.ref_jobNo,
s.empName,
(SELECT t.documentID FROM tax_invoice_items as t WHERE t.invNo=j.documentID LIMIT 1) as taxivRef,
rf.status_name
...
?>
                <tr>
                  ...
                  <td><?php echo $r['custNameTH'];?></td>
                       <td><?php echo $r['ref_jobNo'];?></td>
                       <td><?php echo $r['taxivRef'];?></td>
...
?>						
                      ...
                      <button class="btn-white btn btn-xs" onClick="location.href='invoice_form?action=edit&documentID=<?php echo $r['documentID'];?>' ">Edit</button>
                      <button class="btn-white btn btn-xs" onClick="return confirmDel('<?php echo $r['documentID']; ?>','invoice_action.php');">Delete</button>
	<?php } ?>						
