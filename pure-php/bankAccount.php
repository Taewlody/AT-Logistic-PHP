...
<div class="row wrapper border-bottom white-bg page-heading">
  <div class="col-lg-10">
    <h2>Common Data/ Bank Account</h2>
    <ol class="breadcrumb">
    ...
    <div class="col-lg-12">
      <div class="ibox ">
        <div class="ibox-title">
          <h5><a>Bank</a> List</h5>
          <div class="ibox-tools"> <a href="bankAccount_form?action=add" class="btn btn-primary btn-xs"><i class="fa fa-plus "> </i> Create new </a> </div>
        </div>
...
INNER JOIN $db->dbname.user AS u ON c.comCode = u.comCode AND c.createID = u.usercode order by c.accountName  ";
$result=$db->query($sql);
$i=1;
$isActiveStype="";
...
?>
                <tr class="gradeX">
                  ...
                  <td class="center">
                    <div class="btn-group">
                      <button class="btn-white btn btn-xs" onClick="location.href='bankAccount_form?action=view&accountCode=<?php echo $r['accountCode'];?>' ">View</button>
                      <button class="btn-white btn btn-xs" onClick="location.href='bankAccount_form?action=edit&accountCode=<?php echo $r['accountCode'];?>' ">Edit</button>
                      <button class="btn-white btn btn-xs" onClick="return confirmDel('<?php echo $r['accountCode']; ?>','bankAccount_action.php');">Delete</button>
                    </div>
                </tr>
<?php  
}
