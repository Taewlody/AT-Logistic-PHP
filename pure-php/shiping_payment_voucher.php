...
<div class="wrapper wrapper-content animated fadeInRight ecommerce">
  ...
  <div class="ibox-title">
          ...
          <div class="ibox-tools"> 
			  <a href="shiping_payment_voucher_form?action=add" class="btn btn-primary btn-xs"><i class="fa fa-plus "> </i> Create new </a> 
...
?>
                <tr>
                  ...
                  <td class="center">
                    <div class="btn-group">
<button class="btn-white btn btn-xs" onClick="location.href='shiping_payment_voucher_form?action=view&documentID=<?php echo $r['documentID'];?>' ">View</button>
 <?php if($r['documentstatus']!='A'){ ?>                       
<button class="btn-white btn btn-xs" onClick="location.href='shiping_payment_voucher_form?action=edit&documentID=<?php echo $r['documentID'];?>' ">Edit</button>
    <?php } ?>                    

                        <button class="btn-white btn btn-xs" onClick="return confirmDel('<?php echo $r['documentID']; ?>','shiping_payment_voucher_action.php');">Delete</button>
                    </div>
                  </td>
                </tr>
                <?php  
