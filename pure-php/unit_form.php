...
WHERE c.comCode='$db->comCode' AND c.unitCode='$unitCode' ";
if ($r = $db->fetch($sql)) {
  $unitName = $r['unitName'];;
  $isActive = $r['isActive'];
  $readonly = 'readonly';
...
<div class="row wrapper border-bottom white-bg page-heading">
  <div class="col-lg-10">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"> <a>Unit Form</a></li>
    </ol>
  </div>
        ...
        <div class="ibox-content">
          <form name="form" id="form" action="" enctype="multipart/form-data" method="post">
            ...
            <div class="form-group  row">
              ...
              <div class="col-md-2">
                <input name="unitCode" type="text" class="form-control " id="unitCode" readonly autocomplete="off" value="<?php echo $unitCode; ?>" <?php echo $readonly; ?>>
              </div>
            </div>

            <div class="form-group  row">
              <label class="col-sm-2 col-form-label"> Name</label>
              <div class="col-sm-8"><input name="unitName" type="text" class="form-control " id="unitName" autocomplete="empty" value="<?php echo $unitName; ?>"></div>
            </div>
            ...
            <div class="form-group row">
              <div class="col-sm-4 col-sm-offset-2">
                <button name="back" class="btn btn-white" type="button" onclick="window.location='unit'"><i class="fa fa-reply"></i> Back</button>
