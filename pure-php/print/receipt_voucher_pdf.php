...
class MYPDF extends TCPDF {
	...
	public function Header() {
       ...
       // $this->SetTextColor(0, 139, 139);
		$this->SetFont('thsarabun', 'B', 18);
		$this->Cell(0, 15,'ใบสำคัญรับ', 0, false, 'C', 0, '', 0, false, 'M', 'M');  
		$this->Ln(5);
		$this->Cell(0, 15,'Receipt VOUCHER', 0, false, 'C', 0, '', 0, false, 'M', 'M');  
        
        $this->SetTextColor(0, 0, 0);
        $this->SetFont('thsarabun', 'B', 15);
		$this->Ln(10);
		$this->Cell(0, 15,'รับจาก', 0, false, 'L', 0, '', 0, false, 'M', 'M');
        $this->SetX(50);
        $this->SetFont('thsarabun', '', 15);
        ...
        $this->SetX(130);
        $this->SetFont('thsarabun', 'B', 15);
        $this->Cell(0, 15,'บัญชีธนาคาร', 0, false, 'L', 0, '', 0, false, 'M', 'M');
        $this->SetFont('thsarabun', '', 15);
        $this->SetX(150);
...
INNER JOIN $db->dbname.receipt_voucher AS p ON t.comCode = p.comCode AND t.documentID = p.documentID
