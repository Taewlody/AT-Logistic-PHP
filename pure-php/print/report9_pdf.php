...
class MYPDF extends TCPDF {
	...
	public function Header() {
		...
		$this->Cell(0, 15,'รายงานภาษีซื้อ', 0, false, 'C', 0, '', 0, false, 'M', 'M');  
...
$html='<table width="100%" border="1"  cellpadding="1" >
    ...
    <tr>
      ...
      <td width="33%" rowspan="2" align="center" width="37%">ชื่อผู้ขายสินค้า/ผู้ให้บริการ</td>
...
$html.='<tr>
      ...
      <td width="15%" align="center">'.$r['invNo'].'</td>
      <td width="37%" align="left">'.$r['supNameTH'].'</td>
      <td width="13%" align="right">'.n2($r['sumTotal']).'</td>
      <td width="13%" align="right" >'.n2($r['sumTax7']).'</td>
    </tr>';
$i++;
}	
