...
<div class="row wrapper border-bottom white-bg page-heading">
  <div class="col-lg-10">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item">Receipt Voucher</li>
    </ol>
  </div>
...
<div class="wrapper wrapper-content animated fadeInRight ecommerce">
  ...
  <div class="ibox-title">
          ...
          <div class="ibox-tools"> 
			  <a href="receipt_voucher_form?action=add" class="btn btn-primary btn-xs"><i class="fa fa-plus "> </i> Create new </a> 
...
j.grandTotal,
rf.status_name
FROM $db->dbname.receipt_voucher AS j
...
?>
                <tr>
                 ...
                 <td><?php echo $r['refJobNo'];?></td>
                  ...
                  <td class="center">
                    <div class="btn-group">
<button class="btn-white btn btn-xs" onClick="location.href='receipt_voucher_form?action=view&documentID=<?php echo $r['documentID'];?>' ">View</button>
<?php
if ($r['documentstatus']!='A' || $_SESSION['userTypecode']=='1') {
?>	                     
<button class="btn-white btn btn-xs" onClick="location.href='receipt_voucher_form?action=edit&documentID=<?php echo $r['documentID'];?>' ">Edit</button>
<button class="btn-white btn btn-xs" onClick="return confirmDel('<?php echo $r['documentID']; ?>','receipt_voucher_action.php');">Delete</button>
<?php } ?>  
					 </div>
                  </td>
                </tr>
