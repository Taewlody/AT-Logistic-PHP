...
<div class="row wrapper border-bottom white-bg page-heading">
  <div class="col-lg-10">
    <h2>รายงาน งานระหว่างทำ</h2>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"> <a>Home</a></li>
      <li class="breadcrumb-item"> <a>Report</a></li>
      <li class="breadcrumb-item">รายงาน งานระหว่างทำ</li>
    </ol>
  </div>
            ...
            <div class="row">
              ...
              <thead>
                <tr>
                  ...
                  <th  width="10%">Time period (Day)</th>
...
c.custNameTH,
s.empName,
DATEDIFF(NOW(),j.documentDate) as diff,
rf.status_name
...
?>
                <tr>
                  ...
                  <td class="center"><?php echo $r['diff']; ?></td>
                  <td class="center">
                    <div class="btn-group">
