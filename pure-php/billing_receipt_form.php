...
<div class="row wrapper border-bottom white-bg page-heading">
  <div class="col-lg-6">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item">Billing receipt</li>
      <li class="breadcrumb-item"> <a>Billing receipt Form</a></li>
    </ol>
  </div>
</div>
    ...
    <div class="col-lg-6">
      <div class="ibox ">
        ...
        <div class="ibox-content">
          ...
          <div class="form-group  row">
            <label class="col-sm-3 col-form-label">Ref. Job No.</label>
            <div class="col-md-9">
    ...
    <div class="col-lg-6">
      <div class="ibox ">
        ...
        <div class="ibox-content">
          ...
          <div class="form-group  row">
            <label class="col-sm-3 col-form-label">Suppliler</label>
            <div class="col-md-9">
              <select class="select2_single form-control select2">
                <option value="1">Select</option>
                <option value="2">Select</option>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9">
              <input type="text" name="cusCode4" class="form-control">
            </div>
          </div>
        ...
        <div class="ibox-content">
          ...
          <div class="form-group row">
            <div class="col-sm-10 col-sm-offset-2">
              ...
              <button name="back" class="btn btn-white" type="button" onclick="window.location='billing_receipt'"><i class="fa fa-reply"></i> Back</button>
