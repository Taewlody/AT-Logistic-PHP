...
p.editID,
p.editTime
FROM $db->dbname.advance_payment AS p
    ...
    $("#save").click(function(event) {
      ...
      if ($('#form').valid()) {
        ...
        $.ajax({
          ...
          url: "advance_payment_action.php",
          data: data,
          processData: false,
          contentType: false,
          cache: false,
 ...
 console.log("Result : ", data);
    ...
    $("#btnUpload").click(function(event) {
      ...
      $.ajax({
        type: "POST",
        enctype: 'multipart/form-data',
        url: "advance_payment_upload.php",
        data: data,
        processData: false,
        contentType: false,
        cache: false,
...
<div class="row wrapper border-bottom white-bg page-heading">
  <div class="col-lg-6">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"> <a>Advance Payment</a> </li>
      <li class="breadcrumb-item"> <a>Advance Payment  Form</a></li>
    </ol>
  </div>
</div>
      ...
      <div class="col-lg-7" style="margin-bottom: 1px; ">
        <div class="ibox ">
          ...
          <div class="ibox-content">
            ...
            <div class="form-group row">
              <label class="col-lg-2 col-form-label"><span class="col-form-label" style="padding-top: 5px;">ลูกค้า</span></label>
              <div class="col-md-4">
...
t.fileDetail,
t.fileName
FROM advance_payment_attach AS t
          ...
          <div class="ibox-content">
            ...
            <div class="form-group row">
              <div class="col-sm-10 col-sm-offset-2">
                <button name="back" class="btn btn-white" type="button" onclick="window.location='advance_payment'"><i class="fa fa-reply"></i> Back</button>
                <?php
                if ($documentstatus != 'A' ) {
                ?>
                ...
                if($documentstatus != 'A' or $_SESSION['userTypecode']!='4' or $_SESSION['userTypecode']=='1'){
                
				  
				if($_SESSION['userTypecode']=='1' || $_SESSION['userTypecode']=='7'){  
				  ?>
                ...
                <?php  } }
				  ...
				  ?>
                <button class="btn btn-white " type="button" onclick="window.open('print/advance_payment_pdf.php?documentID=<?php echo $documentID; ?>','_blank')"><i class="fa fa-print"></i> Print</button>
