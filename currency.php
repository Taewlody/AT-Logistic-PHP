    ...
    <div class="col-lg-12">
      <div class="ibox ">
        <div class="ibox-title">
          ...
          <div class="ibox-tools"> <a href="currency_form?action=add" class="btn btn-primary btn-xs"><i class="fa fa-plus "> </i> Create new </a> </div>
        </div>
...
INNER JOIN $db->dbname.user AS u ON c.comCode = u.comCode AND c.createID = u.usercode order by c.currencyCode  ";
$result=$db->query($sql);
$i=1;
$isActiveStype="";
...
?>
                <tr class="gradeX">
                  <td><?php echo $i++; ?></td>
                  <td><?php echo $r['currencyCode'];?></td>
                  <td><?php echo $r['currencyName']; ?></td>
                  <td><?php echo $r['exchange_rate']; ?></td>
                  ...
                  <td class="center">
                    <div class="btn-group">
                      <button class="btn-white btn btn-xs" onClick="location.href='currency_form?action=view&currencyCode=<?php echo $r['currencyCode'];?>' ">View</button>
                      <button class="btn-white btn btn-xs" onClick="location.href='currency_form?action=edit&currencyCode=<?php echo $r['currencyCode'];?>' ">Edit</button>
                      <button class="btn-white btn btn-xs" onClick="return confirmDel('<?php echo $r['currencyCode']; ?>','currency_action.php');">Delete</button>
                    </div>
                </tr>
<?php  
}
